...
Java_com_stomhong_easyffmpeg_AudioOpenSLActivity_play
...
//创建引擎和输出混响对象
JNIEXPORT JNICALL void
Java_com_stomhong_easyffmpeg_AudioOpenSLActivity_createEngine(JNIEnv *env, jclass clazz) {
    // create engine
...
// 停止播放
JNIEXPORT JNICALL void
Java_com_stomhong_easyffmpeg_AudioOpenSLActivity_stop(JNIEnv *env, jclass clazz) {
...
Java_com_stomhong_easyffmpeg_AudioOpenSLActivity_destroy(JNIEnv *env, jclass clazz) {
    //    //释放资源
